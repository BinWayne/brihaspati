...
/**
 */
public abstract class BaseExamPeer
    extends BasePeer
{
    ...
    {
        return getMapBuilder(ExamMapBuilder.CLASS_NAME);
    }

      /** the column name for the EXAM_ID field */
    public static final String EXAM_ID;
      /** the column name for the TITLE field */
    public static final String TITLE;
      /** the column name for the TIME_OF_EXAM field */
    public static final String TIME_OF_EXAM;
      /** the column name for the UPLOADED_BY field */
    public static final String UPLOADED_BY;
      /** the column name for the DATE_UPLOADED field */
    public static final String DATE_UPLOADED;
    ...
    public static void addSelectColumns(Criteria criteria)
            throws TorqueException
    {
          criteria.addSelectColumn(EXAM_ID);
          criteria.addSelectColumn(TITLE);
          criteria.addSelectColumn(TIME_OF_EXAM);
          criteria.addSelectColumn(UPLOADED_BY);
          criteria.addSelectColumn(DATE_UPLOADED);
          criteria.addSelectColumn(INSTRUCTIONS);
      }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Exam row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            Record row = (Record) records.get(i);
              results.add(ExamPeer.row2Object(row, 1,
                ExamPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(Exam obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Exam obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Exam obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Exam obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Exam) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Exam obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Exam) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Exam obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Exam) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Exam obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Exam obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
                criteria.add(EXAM_ID, obj.getExamId());
     ...
     */
    public static Exam retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Exam retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
