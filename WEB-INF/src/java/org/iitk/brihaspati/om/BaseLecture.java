...
public abstract class BaseLecture extends BaseObject
{
    ...
    /** The value for the repeatlec field */
    private String repeatlec;
    ...
    /**
     * Set the value of Repeatlec
     *
     * @param v new value
     */
    public void setRepeatlec(String v) 
    {
    
                  if (!ObjectUtils.equals(this.repeatlec, v))
              {
            this.repeatlec = v;
            setModified(true);
        }
    ...
    protected Lecture copyInto(Lecture copyObj) throws TorqueException
    {
          ...
          copyObj.setRepeatlec(repeatlec);
