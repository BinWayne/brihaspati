 ...
 * extended all references should be to Course
 */
public abstract class BaseCourse extends BaseObject
{
    /** The Peer class */
    ...
    public void save(Connection con) throws TorqueException
    {
          if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    CoursePeer.doInsert((Course) this, con);
                    setNew(false);
                }
                else
                {
                    CoursePeer.doUpdate((Course) this, con);
                }
            }
    ...
    {
        return copyInto(new Course());
    }
  
    protected Course copyInto(Course copyObj) throws TorqueException
    {
