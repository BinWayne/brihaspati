    ...
    extends BasePeer
{
    ...
    public static final String QUOTA;
      /** the column name for the USER_LANG field */
    public static final String USER_LANG;
    ...
    static
    {
          ...
          QUOTA = "TURBINE_USER.QUOTA";
          USER_LANG = "TURBINE_USER.USER_LANG";
          if (Torque.isInit())
        {
            try
            {
    ...
    protected static final String CLASSNAME_DEFAULT =
        "org.iitk.brihaspati.om.TurbineUser";
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(USER_LANG);
      }
        ...
        throws TorqueException
    {
        try
        {
                obj.setUserId(row.getValue(offset + 0).asInt());
                  ...
                  obj.setQuota(row.getValue(offset + 11).asBigDecimal());
                  obj.setUserLang(row.getValue(offset + 12).asString());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
        ...
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
                criteria.add(USER_ID, obj.getUserId());
                  ...
                  criteria.add(USER_LANG, obj.getUserLang());
          return criteria;
    }
