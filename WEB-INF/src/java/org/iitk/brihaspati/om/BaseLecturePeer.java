    ...
    extends BasePeer
{
    ...
    public static final String DURATION;
      /** the column name for the REPEATLEC field */
    public static final String REPEATLEC;
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(REPEATLEC);
        ...
        throws TorqueException
    {
        try
        {
                obj.setLectureid(row.getValue(offset + 0).asInt());
                  ...
                  obj.setRepeatlec(row.getValue(offset + 12).asString());
        ...
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
                criteria.add(LECTUREID, obj.getLectureid());
                  ...
                  criteria.add(REPEATLEC, obj.getRepeatlec());
