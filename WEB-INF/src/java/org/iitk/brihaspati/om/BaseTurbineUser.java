...
public abstract class BaseTurbineUser extends BaseObject
{
    ...
    private Date created = new Date(20100120);
                                                  
    /** The value for the lastLogin field */
    private Date lastLogin = new Date(20100120);
    ...
    /** The value for the userLang field */
    ...
    /**
     * Set the value of UserLang
     *
     * @param v new value
     */
    public void setUserLang(String v) 
    {
    
                  if (!ObjectUtils.equals(this.userLang, v))
              {
            this.userLang = v;
            setModified(true);
        }
